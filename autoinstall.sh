...
##############################################
if grep -q 'VERSION="10 (buster)"' /etc/os-release; then
  wget -P /tmp https://github.com/maltsevvv/maltsev-Kodi-Repo/raw/master/kodi18/skin.rnsd/skin.rnsd-18.2.7.zip
  ...
  wget -P /tmp https://github.com/maltsevvv/maltsev-Kodi-Repo/raw/master/kodi19/skin.rnsd/skin.rnsd-19.2.7.zip
